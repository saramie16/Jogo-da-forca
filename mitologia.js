const deuses = ["Zeus", "Hera", "Poseidon", "Atena", "Ares", "Apoolo", "Hefesto", "Afrodite", "Hermes", "Dioniso", "Hades", "Eros", "Euro", "Hebe", "Nice", "Nemesis", "Alfeu"];
const palavraSecreta = deuses[Math.floor(Math.random() * deuses.length)];
const letrasErradas = [];

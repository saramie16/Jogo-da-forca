const paises= ["Brasil", "Alemanha", "Angola", "Argentina", "Bahamas", "Venezuela", "Chile", "Uruguai", "Uganda", "Turquia", "Tonga", "Suriname", "Singapura", 
"Senegal", "Portugal", "Paraguai", "Nepal", "Jamaica", "Honduras", "Guiana", "Egito", "Brunei", "Catar", "Cuba", "Gana", "Espanha", "Marrocos", "Peru"];
const palavraSecreta = paises[Math.floor(Math.random() * paises.length)];
const letrasErradas = [];

const esportes = ["futebol", "atletismo", "badminton", "baisebol", "boxe", "esgrima", "futsal", 
"golfe", "handebol", "remo", "rugby", "voleibol", "xadrez", "fisiculturismo"];
const palavraSecreta = esportes[Math.floor(Math.random() * esportes.length)];
const letrasErradas = [];

const animais = ["gato", "cachorro", "galinha", "vaca", "javali", "cavalo", "tatu", "rato","peixe", "abelha", 
"elefante", "gorila", "raposa", "borboleta", "sapo", "urso", "capivara"];
const palavraSecreta = animais[Math.floor(Math.random() * animais.length)];
const letrasErradas = [];
